...
MisplacedTiles::MisplacedTiles(unsigned short **final_map, size_t size) : Manhattan(final_map, size) {}


int MisplacedTiles::distance(const unsigned short * const *map) const {
	int pos;
	int x_final;
	int y_final;
	int cumul = 0;
